...
| Retained callbacks | Owner table foundation implemented | Slot/generation tokens linearize close with atomic leases; the owner table explicitly roots active anchors and releases them after cancellation plus the final lease; add result-handle association, generated payload/invocation thunks, and native cancellation lowering | scriptc fork |
