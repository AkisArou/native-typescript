...
and the real GTK fixture's GLib runtime and wrapper objects use that path. The
ScriptC-generated units and final GTK link are not graph actions yet. Only
